...
create_rc_corner -name RC_CORNER \
    -qx_tech_file {/home/install/FOUNDRY/digital/90nm/dig/qrc/gpdk090_9l.tch} \
    -preRoute_res 1.0 \
    -preRoute_cap 1.0 \
    -postRoute_res 1.0 \
    -postRoute_cap 1.0
...
# -------- Constraint Mode --------
create_constraint_mode -name constr -sdc_files [list /home/super/circuits/virtuoso_test/rtl2gds/synthesis/output/counter_out.sdc]
